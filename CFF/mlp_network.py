...
class IBRNet(nn.Module):
    ...
    def forward(self, rgb_feat, ray_diff, mask, cff_features=None):
        '''
        ...
        :param cff_features: (optional) CFF scene-specific features [n_rays, n_samples, cff_out_dim]
        ...
        # -------- CFF injection: add scene-specific 3D features --------
        if cff_features is not None:
            globalfeat = globalfeat + cff_features  # [n_rays, n_samples, 16]
        # ----------------------------------------------------------------
